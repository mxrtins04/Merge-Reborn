...
export default function ForgotPasswordScreen() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMsg('Request submitted. Redirecting to password reset…');
  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-[400px] animate-fade-up">
        <div className="mb-8">
          <h1 className="font-display text-[22px] font-bold text-[#e1e2ec] tracking-tight">Reset password</h1>
        ...
        <div className="w-full bg-[#16181D] border border-[#27272A] p-8">
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-2">
              <label className="block font-mono-code text-[10px] text-[#c2c6d6] uppercase tracking-widest" htmlFor="forgot_email">
                Email Address
              </label>
              <input
                id="forgot_email"
